<div class="section bg-primary" id="user-section">
    <div id="user-detail">
        <div class="avatar">
            <img src="<?= base_url('foto'); ?>/<?= $karyawan['foto_karyawan'] ?>" alt="avatar" class="imaged w64 rounded" />
        </div>
        <div id="user-info">
...
<div class="section mt-2" id="presence-section">
    ...
    <div class="rekappresence mt-1">
        <div class="col">
            <canvas id="myChart" style="min-height: 600px; height: 600px; max-height: 600px; max-width: 100%;"></canvas>
        </div>
    </div>
    ...
    <div class="presencetab mt-2">
        ...
        <div class="tab-content mt-2" style="margin-bottom: 100px">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel">
                <ul class="listview image-listview">
                    <?php foreach ($leaderboard as $key => $value) { ?>
                        <li>
                            <div class="item">
                                <img src="<?= base_url('foto/' . $value['foto_karyawan']); ?>" alt="image" class="image" />
                                <div class="in">
            ...
            <div class="tab-content mt-4" style="margin-bottom: 100px">
                <a href="<?= base_url('Auth/logOut'); ?>" class="btn btn-danger  btn-block"><i class="fas fa-sign-out-alt mr-1"></i>Logout</a>
            </div>
        </div>
    </div>
</div>