...
<div class="row" style="margin-top : 70px;">
    <div class="col">
        ...
        <button class="btn btn-primary btn-block btn-flat" id="TakeAbsen"><i class="fa fa-camera mr-1"></i> Absen Masuk</button>
        <input type="hidden" name="lokasi" id="lokasi">
        <div id="map" style="width:100%; height: 400px;"></div>
        <audio id="notifikasi_in">
            <source src="<?= base_url('sound/masuk.mp3') ?>" type="audio/mpeg">
        </audio>
    </div>
</div>
<script>
